...
namespace ShipDock.Applications
{
    public static class AppPaths
    {
        ...
        public static string ABBuildOutputTempRoot { get; } = Application.dataPath.Append(StringUtils.PATH_SYMBOL, outputPath, "{0}/", resDataRoot);//需要做字符串格式化
        ...
        public static string PersistentResDataRoot { get; } = Application.persistentDataPath.Append(StringUtils.PATH_SYMBOL, resDataRoot);
