...
namespace ShipDock.FSM
{
    ...
    public class AnimatorParamer
    {
        ...
        {
            bool flag = IsCurentMotionComplete(completionLen, layerIndex, isRewind);
            return flag && IsMotion(animationName);
        }

        public bool IsCurentMotionComplete(float completionLen = 1f, int layerIndex = 0, bool isRewind = false)
        {
